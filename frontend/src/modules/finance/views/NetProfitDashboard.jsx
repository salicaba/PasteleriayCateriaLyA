...
export const NetProfitDashboard = () => {
  ...
  if (isPageLoading) {
    return (
      <div className="h-full w-full flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-950 lya:bg-lya-bg transition-colors duration-300">
        ...
        >
          <Wallet size={40} className="text-emerald-500 lya:text-lya-primary" />
        </motion.div>
        ...
        <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mt-2 flex items-center gap-2">
          <Loader2 size={16} className="animate-spin text-emerald-500 lya:text-lya-primary" /> Generando estado de resultados...
        </p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <header className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 mb-8 bg-white dark:bg-gray-900 lya:bg-lya-surface p-6 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-800 lya:border-lya-border/30 shrink-0 z-20 relative transition-colors">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400 lya:text-lya-text/60 mt-1 transition-colors">Análisis de Utilidad Neta y Costos de 𝓛𝔂𝓪.</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar pb-20 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="bg-white dark:bg-gray-900 lya:bg-lya-surface p-6 md:p-8 rounded-[2rem] shadow-sm border-2 border-emerald-100 dark:border-emerald-900/30 lya:border-lya-primary/30 relative overflow-hidden transition-colors">
          ...
          <motion.div variants={itemVariants} className="bg-white dark:bg-gray-900 lya:bg-lya-surface p-6 md:p-8 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-800 lya:border-lya-border/40 w-11/12 mx-auto transition-colors">
          ...
          <motion.div variants={itemVariants} className="bg-blue-50 dark:bg-blue-900/10 lya:bg-lya-primary/10 p-6 md:p-8 rounded-[2rem] border border-blue-100 dark:border-blue-900/30 lya:border-lya-primary/20 w-10/12 mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-2 transition-colors">
          ...
          <motion.div variants={itemVariants} className="bg-gray-900 dark:bg-black lya:bg-lya-primary p-8 md:p-12 rounded-[2.5rem] shadow-2xl relative overflow-hidden transform transition-all">
