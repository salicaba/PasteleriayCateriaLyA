...
import { Zap, Wrench, Package, Briefcase, Megaphone, HelpCircle, Plus, Calendar, AlertTriangle, Loader2 } from 'lucide-react'; // 🔥 NUEVO: Importamos Loader2
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            <div className="bg-red-50 dark:bg-red-900/10 lya:bg-lya-secondary/10 border border-red-100 dark:border-red-900/30 lya:border-lya-secondary/20 p-8 rounded-3xl flex justify-between items-center shadow-sm transition-colors">
              <div>
            ...
            <div className="bg-white dark:bg-gray-900 lya:bg-lya-surface rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 lya:border-lya-border/30 flex-1 p-6 transition-colors">
              ...
              {isLoading ? (
                <div className="flex justify-center items-center py-10 opacity-50">
                  <Briefcase className="animate-pulse text-gray-400 dark:text-gray-500 lya:text-lya-primary" size={40} />
                </div>
              ) : expenses.length === 0 ? (
