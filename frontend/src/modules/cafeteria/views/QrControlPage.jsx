        ...
        <AnimatePresence>
          {previewMesa && (
            ...
            >
              ...
              />
              <motion.div 
                /* 🚀 1. Reducimos la distancia inicial para evitar saltos largos */
                initial={{ scale: 0.96, opacity: 0, y: 15 }} 
                animate={{ scale: 1, opacity: 1, y: 0 }} 
                exit={{ scale: 0.96, opacity: 0, y: 15 }}
                /* 🚀 2. Adiós "spring". Usamos una curva "tween" súper fluida y estable para SVGs */
                transition={{ duration: 0.25, ease: "easeOut" }}
                /* 🚀 3. MAGIA ANTI-PARPADEO: Fuerza la creación de una capa GPU aislada */
                style={{ 
